...
import { createGroupSchema, deleteMemberSchema, updateMembershipSchema, updateGroupSchema, groupIdSchema, passAdminRightsSchema } from '../validation/groupValidation.js';
...
router
    ...
    .delete('/membership/:id/:userId', validate(deleteMemberSchema), groupController.deleteMember)
